...
const TopFolderMenu = () => {
  ...
  return (
    <Menu className='muipopup1' open={openMenu} onClose={closeMenu} style={{top:'6%',right:'40% !important'}} transformOrigin={{ horizontal: 'right', vertical: 'top' }}
    anchorOrigin={{ horizontal: 'right', vertical: 'top' }}>
       <div className='clipboard-container'>
        <span>Clipboard</span>
        <span><bs.BsThreeDotsVertical /></span>
       </div>
       ...
       <div className='show-all'>
        <span>Show All</span>
        <span><io.IoIosArrowForward /></span>
       </div>
