...
import "../sass/StepsCheckedAll/steps-checked-all.css";
...
const SearchedStepsCheckedAll = () => {
  ...
  const SearchMenuOptions = [
    "Export to EA Files",
    "Audit",
    "Save Searching Crtiteria",
    "Show Saved Searching Criteria",
    "Reset Filters",
  ];
    ...
    <>
      <div className="container p-3 result-card steps-card">
        ...
        <div className="row user-search-top mx-auto">
          ...
          <div
            className="col-xxl-3 col-lg-4 col-md-6 mb-md-3 mb-3 date"
            onClick={() => {
              setDateType("date");
            }}
          >
                  ...
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#buisnessContext"
                        type="button"
                        role="tab"
                        aria-controls="buisnessContext"
                        aria-selected="true"
                      >
                        Buisness Context
                      </button>
